				...
				var smartActions = {
				    ...
				    resetWidgets: function($this){
						...
						$.SmartMessageBox({
							...
							content : $.widresetMSG || "Would you like to RESET all your saved widgets and clear LocalStorageddddddddddddddd?",
							buttons : '[No][Yes]'
						}, function(ButtonPressed) {
		...
		return {
			...
			link: function(scope, element, attrs) {
			    ...
			    scope.toggleSettings=function(){
				    $('#footer .settings-menu').toggle();
				}
				
				/*
				 * FIXED HEADER
				 */
				 scope.fixedHeader=function($event){
				 ...
				 * FIXED RIBBON
				 */
				 scope.fixedRibbon=function($event){
				  	if ($($event.target).is(':checked')) {
				 ...
				 * FIXED Footer
				 */
				 scope.fixedFooter=function($event){
				 	if ($($event.target).is(':checked')) {
				            //checked
				 ...
				 * RTL SUPPORT
				 */
				 scope.rtlSupport=function($event){
				 	if ($($event.target).is(':checked')) {
				            //checked
				 ...
				 * MENU ON TOP
				 */
				scope.menuOnTop=function($event){
				 	if ($($event.target).is(':checked')) {
				 ...
				 * REFRESH WIDGET
				 */
				 scope.resetWidgets=function($event){
				 	 $('#refresh').click();
				      return false;
				 }
				/*
				 * STYLES
				 */
				 scope.smartStyles=function($event){
